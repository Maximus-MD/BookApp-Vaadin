...
const vn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Re = "copilot-", nl = "24.8.1", rl = "undefined", yu = "attention-required", wu = "https://plugins.jetbrains.com/plugin/23758-vaadin", Eu = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Ou(e) {
...
function ic() {
  Ee.push(import("./copilot-log-plugin-DzuOMlGq.js")), Ee.push(import("./copilot-info-plugin-D1NQ6cuk.js")), Ee.push(import("./copilot-features-plugin-j7bwapGC.js")), Ee.push(import("./copilot-feedback-plugin-Bp2pyNlX.js")), Ee.push(import("./copilot-shortcuts-plugin-CIp7aAX9.js"));
}
function oc() {
  {
...
let si = class extends rc {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-Dj1Mh4br.js"), await import("./copilot-init-step2-BQBYk43U.js"), dl(), ic(), this.tabIndex = 0, Vt.hostConnectedCallback(), window.addEventListener("keydown", qn), this.addEventListener("keydown", ai), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
